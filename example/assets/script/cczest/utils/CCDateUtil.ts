...
export  class CCDateUtil {
     ...
     * @param date2 
     */
    public static compareDate(time1: number, time2: number, compare: (a: cc_zest_utils_date_compare_type, b: cc_zest_utils_date_compare_type) => boolean) {
        let date1: Date = new Date(time1);
        let date2: Date = new Date(time2);
        
        let a: cc_zest_utils_date_compare_type = {year: date1.getFullYear(), month: date1.getMonth() + 1, date: date1.getDate(), hours: date1.getHours()};
        let b: cc_zest_utils_date_compare_type = {year: date1.getFullYear(), month: date2.getMonth() + 1, date: date2.getDate(), hours: date2.getHours()};
        return compare(a, b);
    }
    ...
    public static dateFormat(): string {
        ...
        if (args === null || args.format === null || args.format === '') {
            ...
            return CCStringUtil.format(args.format, year, month, day, hours, minutes, seconds, milliseconds);
        }
    }
